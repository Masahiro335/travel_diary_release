...
require_once __DIR__ . '/paths.php';
 ...
 /*
 * 定数設定用のファイルを読込。OPERATING_ENVを適切に設定しておくこと。
 */
define('OPERATING_ENV', env('OPERATING_ENV', '') != '' ? env('OPERATING_ENV', '') : '');
require_once __DIR__ . '/paths_' . OPERATING_ENV . '.php';
define('OPERATING_ENV_LOCAL', 'local');
define('OPERATING_ENV_RELEASE', 'release');
